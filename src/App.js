    ...
    return (
        <div  style={{width: '100vw' , overflowX: 'hidden'}} className="fondo d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="text-center row mt-2 d-flex justify-content-center align-items-center boxTiempo">
                <div className='d-flex justify-content-center align-items-center border border-dark procimaFecha'>
                  <p className="letra" style={{fontSize:'32.5px' , letterSpacing:'9.5px' , margin:'0px'}}>PROXIMA FECHA</p>
                </div>
                <div className=' border border-dark tiempos' style={{width: '20%'}}>
                  <p className="text-center ajuste1" style={{borderBottom: 'black solid 1px' }}>DIAS</p>
                  <p style={{fontSize: '25px' , fontWeight: '3.5px' }} className="text-center">{dias}</p>
                </div>
                <div className=' border border-dark tiempos' style={{width: '20%'}}>
                    <p className="text-center ajuste1" style={{borderBottom: 'black solid 1px' }}>HORAS</p>
